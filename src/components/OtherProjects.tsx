...
export default function OtherProjects() {
    return (
        <div
            className={`bg-charcle py-10 md:pr-24 md:pb-24`}
            >

                <div className="pl-8 md:pl-24">
                    <h2 className="text-4xl text-offwhite">Also worked with:</h2>
                    <span style={{height: "1px"}} className="w-24 bg-offwhite mb-2 block slide-right"/>
                </div>

                    <div className="flex flex-col my-8 max-w-lg">
