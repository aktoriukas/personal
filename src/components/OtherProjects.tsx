...
export default function OtherProjects() {
  return (
    <div className={`bg-charcle py-10 md:pr-24 md:pb-24`}>
        ...
        {supportProjects.map((project, index) => {
          ...
          if (project.title === "Good Caesar") {
            ;(style.backgroundImage =
              "linear-gradient(transparent calc(100% - 1px),rgba(34,34,34,0.08) 1px)"),
          ...
          return (
            ...
            >
              ...
              <h4 className={`${project.dark ? "text-offwhite" : "text-charcle"}`}>
                {project.title}
              </h4>

              <span
                style={{ borderBottomColor: project.color }}
                className="triangle-bottom z-20 opacity-90"
              />
