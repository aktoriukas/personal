    ...
    return (
        <div 
            ...
            <div className="about-project px-8 pb-10 md:px-24 md:pb-32 max-w-4xl relative">
                ...
                <h2 className={`text-4xl md:text-5xl pb-2 slide-left ${dark ? 'text-offwhite' : ''}`}>{title}</h2>

                <div className="stack flex flex-wrap slide-left">
                    {stack.map(item => (
                        <span
                            key={item} 
                ...
                <a className="absolute web-icon right-20 bottom-40" target="_blank" href={project.link}>
                    <svg 
                        id="Layer_1" 
