    ...
    return (
        <div className="relative md:fixed px-8 py-10 md:w-2/5 md:px-24 md:py-32 h-screen bg-offwhite">
            ...
            <div className="h-full flex flex-col justify-end pb-36 md:pb-16 about-content">
                <div className="uppercase text-4xl font-bold about-title">
                    <h1>Web</h1>
                    <h1>Developer,</h1>
                    <h1>Creator</h1>
                </div>
                <p className="mt-4 text-xl font-extralight about-sub-text">Passionate about building exceptional digital solutions that can improve lives for those who use them.</p>
            </div>
